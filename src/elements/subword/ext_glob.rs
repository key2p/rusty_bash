...
use crate::{Feeder, ShellCore, elements::subword::CommandSubstitution, error::parse::ParseError, utils::exit};
...
impl ExtGlob {
    pub fn new() -> ExtGlob {
        ExtGlob { text: String::new(), subwords: vec![] }
    }
    ...
    fn eat_command_substitution(feeder: &mut Feeder, ans: &mut Self, core: &mut ShellCore) -> Result<bool, ParseError> {
