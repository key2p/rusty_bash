...
impl CaseCommand {
    ...
    fn eat_word(feeder: &mut Feeder, ans: &mut Self, core: &mut ShellCore) -> Result<bool, ParseError> {
    ...
    pub fn parse(feeder: &mut Feeder, core: &mut ShellCore) -> Result<Option<CaseCommand>, ParseError> {
