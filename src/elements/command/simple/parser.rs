...
impl SimpleCommand {
    pub fn eat_substitution(feeder: &mut Feeder, ans: &mut Self, core: &mut ShellCore) -> Result<bool, ParseError> {
    ...
    fn eat_word(feeder: &mut Feeder, ans: &mut SimpleCommand, core: &mut ShellCore) -> Result<bool, ParseError> {
        let mut mode = None;
    ...
    pub fn parse(feeder: &mut Feeder, core: &mut ShellCore) -> Result<Option<Self>, ParseError> {
        ...
        loop {
            let exist_redirect = match command::eat_redirects(feeder, core, &mut ans.redirects, &mut ans.text) {
                Ok(exist) => exist,
                Err(e) => {
                    feeder.rewind();
                    return Err(e);
